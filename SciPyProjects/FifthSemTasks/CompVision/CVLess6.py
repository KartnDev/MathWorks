...
cmyk_circle = gcr(circle, 0)
dots_circle = halftone(circle, cmyk_circle, 10, 1)

cv2.imshow('CircleHalftone', dots_circle)
cv2.waitKey(0)

ret, binary = cv2.threshold(dots_circle, 127, 255, cv2.THRESH_BINARY)
