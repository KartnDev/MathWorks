...
try:
    # For my fork in git
    from PyAndMl.MLLec5.plotData import plotData
    from PyAndMl.MLLec5.featureNormalize import featureNormalize
    from PyAndMl.MLLec5.computeCost import computeCost
    from PyAndMl.MLLec5.normalEqn import normalEqn
    from PyAndMl.MLLec5.gradientDescent import gradientDescent
except:
