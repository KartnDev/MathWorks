...
from PyAndMl.MLTask5.plotData import plotData
from PyAndMl.MLTask5.featureNormalize import featureNormalize
from PyAndMl.MLTask5.computeCost import computeCost
from PyAndMl.MLTask5.gradientDescent import gradientDescent
from PyAndMl.MLTask5.normalEqn import normalEqn
...
predict = np.dot(np.array([[1, (1650 - mu[0]) / sigma[0], (3 - mu[1]) / sigma[1]]]), [[89597.9095428],
                                                                                      [139.21067402],
                                                                                      [-8738.01911233]])
